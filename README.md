...
👥 Group Members
HAMZAH ALHADEETHI — B231202561
Ziyad Mohamed Alboghdady - B231202560
AMMAR AL BAGHAJATI — B231202553
Rateb ABAZEED - B221202551
📌 Project Subject
...
Use Case (Scenario):
A 17-year-old student wants to learn how they can get involved in their community. They visit the site, read the mission, explore the gallery for inspiration, and use the contact section to get in touch.
...
Perception: Used color contrast and layout to enhance clarity.
Attention: Visual hierarchy guides user focus to titles, quotes, and buttons.
Memory: Repetition of key themes (“community,” “together”) helps retention.
Learning: Simple navigation aids users in learning the structure quickly.
...
Content Inventory: Home, About, News,Project Gallery, and Contact sections.
Grouping: Grouped related content under intuitive sections.
Hierarchy: Home > Aboutus > Project Gallery / News > Contact.
Navigation: Clear, horizontal menu accessible from all pages.
...
Goal Formation: Users want to learn about community involvement
Execution: Easy to click through sections
Evaluation: Content is clear, progress is visible (e.g. from ِ About us to contact)
🖱 Interaction Style
